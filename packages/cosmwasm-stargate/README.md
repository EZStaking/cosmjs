# @ezstaking/cosmwasm-stargate

[![npm version](https://img.shields.io/npm/v/@ezstaking/cosmwasm-stargate.svg)](https://www.npmjs.com/package/@ezstaking/cosmwasm-stargate)

An SDK to build CosmWasm clients.

## Compatibility

| CosmWasm        | x/wasm    | @ezstaking/cosmwasm-stargate |
| --------------- | --------- | ------------------------- |
