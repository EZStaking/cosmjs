...
[![npm version](https://img.shields.io/npm/v/@ezstaking/cli.svg)](https://www.npmjs.com/package/@ezstaking/cli)
...
```
$ npm install @ezstaking/cli --save-dev
$ ./node_modules/.bin/cosmjs-cli
```
...
```
$ npm install -g @ezstaking/cli
$ cosmjs-cli
```

## Getting started

1. Install `@ezstaking/cli` and run `cosmjs-cli` as shown above
